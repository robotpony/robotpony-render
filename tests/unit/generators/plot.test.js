...
describe('PlotGenerator', () => {
    let generator;
    beforeEach(() => {
        generator = new plot_1.PlotGenerator({ theme: 'robotpony' });
    });
    describe('render', () => {
        ...
        it('should handle different line styles', async () => {
            const solidChart = (0, test_utils_1.createMockPlotChart)({ line: { style: 'solid', points: [[1, 1], [2, 2]] } });
            const dashedChart = (0, test_utils_1.createMockPlotChart)({ line: { style: 'dashed', points: [[1, 1], [2, 2]] } });
    ...
    describe('caption positioning', () => {
        ...
        it('should create caption boxes sized for text content', async () => {
            const shortChart = (0, test_utils_1.createMockPlotChart)({
                captions: [{ text: 'A', x: 5, y: 5 }]
            });
            const longChart = (0, test_utils_1.createMockPlotChart)({
